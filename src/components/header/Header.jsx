    ...
    <div className='w-full sticky top-0 z-50'>
      <div className='w-full bg-amazon_blue text-white px-4 py-3 flex items-center gap-4'>
        ...
        <div className='headerHover hidden mdl:inline-flex'>
          ...
          <p className='text-sm text-lightText font-light flex flex-col'>Delivery to{" "}
            <span className='text-sm font-semibold -mt-1 text-whiteText'>Oman</span></p>
        </div>
        {/* ===== Delivery End ===== */}
        {/* ===== Search Start ===== */}
        ...
        justify-center rounded-tl-md rounded-bl-md'>All<span><ArrowDropDownOutlinedIcon /></span>
            {showAll && (
              <div>
          ...
          <input
            ...
            type='text'
          />
          <span className='w-12 flex items-center justify-center bg-amazon_yellow
