    ...
    return (
        <div className="w-full px-4 h-[36px] bg-amazon_light text-white flex items-center">
            ...
            <ul className="flex items-center gap-2 text-sm tracking-wide">
                ...
                <li className="headerHover hidden md:inline-flex">Todys's Deals</li>
                ...
                bg-opacity-50 z-10">
                    <div className="w-full h-full relative">
                        <motion.div ref={ref} initial={{ x: -500, opacity: 0 }} animate={{ x: 0, opacity: 1 }}
                            ...
                            <span onClick={() => setSidebar(false)} className="cursor-pointer absolute top-0 left-[82%] md:left-[360px] w-10 h-10 text-black flex
                        items-center justify-center border bg-gray-200 hover:bg-red-500
